...
namespace doori::Tnsd{
    ...
    public:
         ...
         */
        explicit Communication(std::function<int(int, string&)> delegation);
        /**
         * 이동생성자 함수
         * @param rhs
         */
        Communication(Communication&& rhs);
        /**
         * 소멸자
         */
        ...
        /**
         * 복사대입연산자 호출금지
         * @param rhs const Communication&
         * @return
         */
        auto operator=(const Communication& rhs) noexcept = delete;
        /**
         * 이동대입연사자
         * @param rhs Communication&&
         * @return 자기자산의 참조값
         */
        auto operator=(Communication&& rhs) noexcept -> Communication&;
    protected:
         /**
