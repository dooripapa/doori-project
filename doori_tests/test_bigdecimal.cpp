...
TEST(Bigdecimal, design_complex) {
    EXPECT_EQ(
            doori::Bigdecimal{"-10000000000000000000000000000"},
            doori::Bigdecimal{"-9123912938129382934829348239"} / doori::Bigdecimal{"0.9123912938129382934829348239"}
    );

    EXPECT_EQ(
            doori::Bigdecimal{"9123912938129382934829348239"},
            doori::Bigdecimal{"8324560980431615848446804538.000241607397553188962"} /
            doori::Bigdecimal{"0.912389348394894584958"}
    );

    EXPECT_EQ(
            doori::Bigdecimal{"0.9123893483"},
            doori::Bigdecimal{"8324560980431615848446804538.000241607397553188962"} /
            doori::Bigdecimal{"9123912938129382934829348239"}
    );

    EXPECT_EQ(
            doori::Bigdecimal{"8324560980431615848446804538000241607397553188962"},
            doori::Bigdecimal{"9123912938129382934829348239"} * doori::Bigdecimal{"912389348394894584958"}
    );

    EXPECT_EQ(
            doori::Bigdecimal{"9123912938129382934829348239"},
            (doori::Bigdecimal{"9123912938129382934829348239"} + doori::Bigdecimal{"9123912938129382934829348239"} +
             doori::Bigdecimal{"9123912938129382934829348239"} + doori::Bigdecimal{"9123912938129382934829348239"}) /
            doori::Bigdecimal{"4"}
    );
